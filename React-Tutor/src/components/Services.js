                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                                    ...
                                    <p className="text-md font-medium">
                                        We specialize in creating and optimizing high-quality, custom websites for businesses and organizations of Dive into a fun and interactive learning journey where you can explore topics like a game. Click on different sections to unlock new information and discover exciting facts. It’s like going on a quest to learn!
                                    </p>
                                </div>
                            </div>
